...
export interface UploadFilesListProps {
  ...
  deleteingIndex: string | null;
  onDeleteingIndex: (x: string | null) => void;
}
...
export type Action =
  ...
  | { type: "setFile"; payload: { fileName: string; filePath: string } }
  | { type: "removeFile" }
...
export interface ExecutionLog {
  id: string; //virtual id io not in database just for frontend use
  user_id: string;
  node_id: string;
  workflow_id: string;
  node_label: string;
